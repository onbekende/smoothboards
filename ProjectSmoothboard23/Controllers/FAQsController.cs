...
namespace ProjectSmoothboard23.Controllers
{
    public class FAQsController : Controller
    {
        ...
        public FAQsController(SmoothboardDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,question,answer,category")] FAQ fAQ)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,question,answer,category")] FAQ fAQ)
        {
            if (id != fAQ.id)
            {
                return NotFound();
